...
namespace HFM.Components
{
    ...
    public class Serializable
    {
        ...
        //衣物本底上限
        public string ClothesBackgroundUP { get; set; }
        //当前Alpha本底下限
        ...
        //衣物本底下限
        public string ClothesBackgroundDown { get; set; }
        //当前Alpha测量数据
        ...
        //衣物一级报警阈值
        public string ClothesAlarmThread { get; set; }
        //当前Alpha二级报警阈值
        ...
        //衣物二级报警阈值
        public string ClothesHighAlarmThread { get; set; }
        //当前Alpha效率
        ...
        //衣物当前效率
        public string ClothesEfficiency { get; set; }
        //当前Alpha阈值
    ...
    public class AlphaBackgroundUp
    {
        ...
        { }
        public AlphaBackgroundUp(string alphaLeftInsideUp="--",string alphaLeftOutsideUp="--",string alphaRightInsideUp="--",string alphaRightOutsideUp="--",string alphaLeftFootUp="--",string alphaRightFootUp="--")
        {
    ...
    public class BetaBackgroundUp
    {
        ...
        { }
        public BetaBackgroundUp(string betaLeftInsideUp="--",string betaLeftOutsideUp="--",string betaRightInsideUp="--",string betaRightOutsideUp="--",string betaLeftFootUp="--",string betaRightFootUp="--")
        {
    ...
    public class AlphaBackgroundDown
    {
        ...
        { }
        public AlphaBackgroundDown(string alphaLeftInsideDown="--",string alphaLeftOutsideDown="--",string alphaRightInsideDown="--",string alphaRightOutsideDown="--",string alphaLeftFootDown="--",string alphaRightFootDown="--")
        {
    ...
    public class BetaBackgroundDown
    {
        ...
        { }
        public BetaBackgroundDown(string betaLeftInsideDown="--",string betaLeftOutsideDown="--",string betaRightInsideDown="--",string betaRightOutsideDown="--",string betaLeftFootDown="--",string betaRightFootDown="--")
        {
    ...
    {
        public AlphaTestData()
        { }
        public AlphaTestData(string alphaLeftInsideTest="--",string alphaLeftOutsideTest="--",string alphaRightInsideTest="--",string alphaRightOutsideTest="--",string alphaLeftFootTest="--",string alphaRightFootTest="--",string alphaClothesTest="--")
        {
            AlphaLeftInsideTest = alphaLeftInsideTest;
            AlphaLeftOutsideTest = alphaLeftOutsideTest;
            AlphaRightInsideTest = alphaRightInsideTest;
            AlphaRightOutsideTest = alphaRightOutsideTest;
            AlphaLeftFootTest = alphaLeftFootTest;
            AlphaRightFootTest = alphaRightFootTest;
            AlphaClothesTest = alphaClothesTest;
        }
        /// <summary>
        /// 左手心Alpha测量值
        /// </summary>
    ...
    public class BetaTestData
    {
        public BetaTestData()
        { }
        public BetaTestData(string betaLeftInsideTest = "--", string betaLeftOutsideTest = "--", string betaRightInsideTest = "--", string betaRightOutsideTest = "--", string betaLeftFootTest = "--", string betaRightFootTest = "--", string betaClothesTest = "--")
        {
            BetaLeftInsideTest = betaLeftInsideTest;
            BetaLeftOutsideTest = betaLeftOutsideTest;
            BetaRightInsideTest = betaRightInsideTest;
            BetaRightOutsideTest = betaRightOutsideTest;
            BetaLeftFootTest = betaLeftFootTest;
            BetaRightFootTest = betaRightFootTest;
            BetaClothesTest = betaClothesTest;
        }
        /// <summary>
        /// 左手心Beta测量值
        /// </summary>
    ...
    {
        public AlphaAlarmThread()
        { }
        public AlphaAlarmThread(string alphaLeftInsideAlarm = "--", string alphaLeftOutsideAlarm = "--", string alphaRightInsideAlarm = "--", string alphaRightOutsideAlarm = "--", string alphaLeftFootAlarm = "--", string alphaRightFootAlarm = "--")
        {
            AlphaLeftInsideAlarm = alphaLeftInsideAlarm;
            AlphaLeftOutsideAlarm = alphaLeftOutsideAlarm;
            AlphaRightInsideAlarm = alphaRightInsideAlarm;
            AlphaRightOutsideAlarm = alphaRightOutsideAlarm;
            AlphaLeftFootAlarm = alphaLeftFootAlarm;
            AlphaRightFootAlarm = alphaRightFootAlarm;
            //AlphaClothesAlarm = alphaClothesAlarm;
        }
        /// <summary>
        /// 左手心Alpha一级报警阈值
        /// </summary>
    ...
    {
        public BetaAlarmThread()
        { }
        public BetaAlarmThread(string betaLeftInsideAlarm = "--", string betaLeftOutsideAlarm = "--", string betaRightInsideAlarm = "--", string betaRightOutsideAlarm = "--", string betaLeftFootAlarm = "--", string betaRightFootAlarm = "--")
        {
            BetaLeftInsideAlarm = betaLeftInsideAlarm;
            BetaLeftOutsideAlarm = betaLeftOutsideAlarm;
            BetaRightInsideAlarm = betaRightInsideAlarm;
            BetaRightOutsideAlarm = betaRightOutsideAlarm;
            BetaLeftFootAlarm = betaLeftFootAlarm;
            BetaRightFootAlarm = betaRightFootAlarm;
            //BetaClothesAlarm = betaClothesAlarm;
        }
        /// <summary>
        /// 左手心Beta一级报警阈值
        /// </summary>
    ...
    {
        public AlphaHighAlarmThread()
        { }
        public AlphaHighAlarmThread(string alphaLeftInsideHAlarm = "--", string alphaLeftOutsideHAlarm = "--", string alphaRightInsideHAlarm = "--", string alphaRightOutsideHAlarm = "--", string alphaLeftFootHAlarm = "--", string alphaRightFootHAlarm = "--")
        {
            AlphaLeftInsideHAlarm = alphaLeftInsideHAlarm;
            AlphaLeftOutsideHAlarm = alphaLeftOutsideHAlarm;
            AlphaRightInsideHAlarm = alphaRightInsideHAlarm;
            AlphaRightOutsideHAlarm = alphaRightOutsideHAlarm;
            AlphaLeftFootHAlarm = alphaLeftFootHAlarm;
            AlphaRightFootHAlarm = alphaRightFootHAlarm;
            //AlphaClothesHAlarm = alphaClothesHAlarm;
        }
        /// <summary>
        /// 左手心Alpha二级报警阈值
        /// </summary>
    ...
    {
        public BetaHighAlarmThread()
        { }
        public BetaHighAlarmThread(string betaLeftInsideHAlarm = "--", string betaLeftOutsideHAlarm = "--", string betaRightInsideHAlarm = "--", string betaRightOutsideHAlarm = "--", string betaLeftFootHAlarm = "--", string betaRightFootHAlarm = "--")
        {
            BetaLeftInsideHAlarm = betaLeftInsideHAlarm;
            BetaLeftOutsideHAlarm = betaLeftOutsideHAlarm;
            BetaRightInsideHAlarm = betaRightInsideHAlarm;
            BetaRightOutsideHAlarm = betaRightOutsideHAlarm;
            BetaLeftFootHAlarm = betaLeftFootHAlarm;
            BetaRightFootHAlarm = betaRightFootHAlarm;
            //BetaClothesHAlarm = betaClothesHAlarm;
        }
        /// <summary>
        /// 左手心Beta二级报警阈值
        /// </summary>
    ...
    {
        public AlphaEfficiency()
        { }
        public AlphaEfficiency(string alphaLeftInsideEff = "--", string alphaLeftOutsideEff = "--", string alphaRightInsideEff = "--", string alphaRightOutsideEff = "--", string alphaLeftFootEff = "--", string alphaRightFootEff = "--")
        {
            AlphaLeftInsideEff = alphaLeftInsideEff;
            AlphaLeftOutsideEff = alphaLeftOutsideEff;
            AlphaRightInsideEff = alphaRightInsideEff;
            AlphaRightOutsideEff = alphaRightOutsideEff;
            AlphaLeftFootEff = alphaLeftFootEff;
            AlphaRightFootEff = alphaRightFootEff;
            //AlphaClothesEff = alphaClothesEff;
        }
    ...
    {
        public BetaEfficiency()
        { }
        public BetaEfficiency(string betaLeftInsideEff = "--", string betaLeftOutsideEff = "--", string betaRightInsideEff = "--", string betaRightOutsideEff = "--", string betaLeftFootEff = "--", string betaRightFootEff = "--")
        {
            BetaLeftInsideEff = betaLeftInsideEff;
            BetaLeftOutsideEff = betaLeftOutsideEff;
            BetaRightInsideEff = betaRightInsideEff;
            BetaRightOutsideEff = betaRightOutsideEff;
            BetaLeftFootEff = betaLeftFootEff;
            BetaRightFootEff = betaRightFootEff;
            //BetaClothesEff = betaClothesEff;
        }
    ...
    public class AlphaThread
    {
        public AlphaThread()
        { }
        public AlphaThread(string alphaLeftInsideThread = "--", string alphaLeftOutsideThread = "--", string alphaRightInsideThread = "--", string alphaRightOutsideThread = "--", string alphaLeftFootThread = "--", string alphaRightFootThread = "--", string alphaClothesThread = "--")
        {
            AlphaLeftInsideThread = alphaLeftInsideThread;
            AlphaLeftOutsideThread = alphaLeftOutsideThread;
            AlphaRightInsideThread = alphaRightInsideThread;
            AlphaRightOutsideThread = alphaRightOutsideThread;
            AlphaLeftFootThread = alphaLeftFootThread;
            AlphaRightFootThread = alphaRightFootThread;
            AlphaClothesThread = alphaClothesThread;
        }
        /// <summary>
        /// 左手心Alpha阈值
        /// </summary>
    ...
    public class BetaThread
    {
        public BetaThread()
        { }
        public BetaThread(string betaLeftInsideThread = "--", string betaLeftOutsideThread = "--", string betaRightInsideThread = "--", string betaRightOutsideThread = "--", string betaLeftFootThread = "--", string betaRightFootThread = "--", string betaClothesThread = "--")
        {
            BetaLeftInsideThread = betaLeftInsideThread;
            BetaLeftOutsideThread = betaLeftOutsideThread;
            BetaRightInsideThread = betaRightInsideThread;
            BetaRightOutsideThread = betaRightOutsideThread;
            BetaLeftFootThread = betaLeftFootThread;
            BetaRightFootThread = betaRightFootThread;
            BetaClothesThread = betaClothesThread;
        }
        /// <summary>
        /// 左手心Beta阈值
        /// </summary>
    ...
    {
        public AlphaAlarmFlag()
        { }
        public AlphaAlarmFlag(string alphaLeftInsideAlarmFlag = "--", string alphaLeftOutsideAlarmFlag = "--", string alphaRightInsideAlarmFlag = "--", string alphaRightOutsideAlarmFlag = "--", string alphaLeftFootAlarmFlag = "--", string alphaRightFootAlarmFlag = "--", string alphaClothesAlarmFlag = "--")
        {
            AlphaLeftInsideAlarmFlag = alphaLeftInsideAlarmFlag;
            AlphaLeftOutsideAlarmFlag = alphaLeftOutsideAlarmFlag;
            AlphaRightInsideAlarmFlag = alphaRightInsideAlarmFlag;
            AlphaRightOutsideAlarmFlag = alphaRightOutsideAlarmFlag;
            AlphaLeftFootAlarmFlag = alphaLeftFootAlarmFlag;
            AlphaRightFootAlarmFlag = alphaRightFootAlarmFlag;
            AlphaClothesAlarmFlag = alphaClothesAlarmFlag;
        }
        /// <summary>
        /// 左手心Alpha报警标志
        /// </summary>
    ...
    {
        public BetaAlarmFlag()
        { }
        public BetaAlarmFlag(string betaLeftInsideAlarmFlag = "--", string betaLeftOutsideAlarmFlag = "--", string betaRightInsideAlarmFlag = "--", string betaRightOutsideAlarmFlag = "--", string betaLeftFootAlarmFlag = "--", string betaRightFootAlarmFlag = "--", string betaClothesAlarmFlag = "--")
        {
            BetaLeftInsideAlarmFlag = betaLeftInsideAlarmFlag;
            BetaLeftOutsideAlarmFlag = betaLeftOutsideAlarmFlag;
            BetaRightInsideAlarmFlag = betaRightInsideAlarmFlag;
            BetaRightOutsideAlarmFlag = betaRightOutsideAlarmFlag;
            BetaLeftFootAlarmFlag = betaLeftFootAlarmFlag;
            BetaRightFootAlarmFlag = betaRightFootAlarmFlag;
            BetaClothesAlarmFlag = betaClothesAlarmFlag;
        }
        /// <summary>
        /// 左手心Beta报警标志
        /// </summary>
    ...
    {
        public AlphaFailedFlag()
        { }
        public AlphaFailedFlag(string alphaLeftInsideFailedFlag = "--", string alphaLeftOutsideFailedFlag = "--", string alphaRightInsideFailedFlag = "--", string alphaRightOutsideFailedFlag = "--", string alphaLeftFootFailedFlag = "--", string alphaRightFootFailedFlag = "--", string alphaClothesFailedFlag = "--")
        {
            AlphaLeftInsideFailedFlag = alphaLeftInsideFailedFlag;
            AlphaLeftOutsideFailedFlag = alphaLeftOutsideFailedFlag;
            AlphaRightInsideFailedFlag = alphaRightInsideFailedFlag;
            AlphaRightOutsideFailedFlag = alphaRightOutsideFailedFlag;
            AlphaLeftFootFailedFlag = alphaLeftFootFailedFlag;
            AlphaRightFootFailedFlag = alphaRightFootFailedFlag;
            AlphaClothesFailedFlag = alphaClothesFailedFlag;
        }
        /// <summary>
        /// 左手心Alpha故障标志
        /// </summary>
    ...
    {
        public BetaFailedFlag()
        { }
        public BetaFailedFlag(string betaLeftInsideFailedFlag = "--", string betaLeftOutsideFailedFlag = "--", string betaRightInsideFailedFlag = "--", string betaRightOutsideFailedFlag = "--", string betaLeftFootFailedFlag = "--", string betaRightFootFailedFlag = "--", string betaClothesFailedFlag = "--")
        {
            BetaLeftInsideFailedFlag = betaLeftInsideFailedFlag;
            BetaLeftOutsideFailedFlag = betaLeftOutsideFailedFlag;
            BetaRightInsideFailedFlag = betaRightInsideFailedFlag;
            BetaRightOutsideFailedFlag = betaRightOutsideFailedFlag;
            BetaLeftFootFailedFlag = betaLeftFootFailedFlag;
            BetaRightFootFailedFlag = betaRightFootFailedFlag;
            BetaClothesFailedFlag = betaClothesFailedFlag;
        }
        /// <summary>
        /// 左手心Beta故障标志
        /// </summary>
